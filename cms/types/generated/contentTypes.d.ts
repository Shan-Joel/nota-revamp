...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: "Every text, image and video on the n\u014Dta homepage, section by section.";
  ...
  attributes: {
    boxSet: Schema.Attribute.Component<"sections.box-set", false> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    footer: Schema.Attribute.Component<"sections.footer", false> & Schema.Attribute.Required;
    hero: Schema.Attribute.Component<"sections.hero", false> & Schema.Attribute.Required;
    insideBox: Schema.Attribute.Component<"sections.inside-box", false> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::homepage.homepage"> &
      Schema.Attribute.Private;
    nav: Schema.Attribute.Component<"sections.nav", false> & Schema.Attribute.Required;
    order: Schema.Attribute.Component<"sections.order", false> & Schema.Attribute.Required;
    ...
    smartPaper: Schema.Attribute.Component<"sections.smart-paper", false> &
      Schema.Attribute.Required;
    specs: Schema.Attribute.Component<"sections.specs", false> & Schema.Attribute.Required;
    syncScene: Schema.Attribute.Component<"sections.sync-scene", false> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    whoFor: Schema.Attribute.Component<"sections.who-for", false> & Schema.Attribute.Required;
  };
}
